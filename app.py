...
# =============================================================================
#  PREMIUM RED & GOLD HOMEPAGE (XANAF LEGACY, TEAM X LEGACY, OMEGA X LEGACY)
# =============================================================================
HOME_PAGE = '''
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>XANAF LEGACY | OB54 Premium Gaming API</title>
...
<body class="pb-20 selection:bg-gold/30">
    ...
    <div id="auth-overlay" class="fixed inset-0 z-[100] bg-[#0f0101] flex items-center justify-center p-4">
        ...
        <div class="glass-premium p-8 rounded-[2.5rem] w-full max-w-sm text-center space-y-6 relative z-10">
            ...
            <div class="space-y-2">
                <h2 class="text-2xl font-black text-gradient uppercase tracking-tighter">OB54 Premium Access</h2>
        ...
        <header class="sticky top-0 z-50 bg-black/50 backdrop-blur-md border-b border-yellow-400/10">
            <div class="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <h1 class="text-lg font-black tracking-tighter text-gradient uppercase">XANAF LEGACY</h1>
                </div>
                <div class="flex items-center gap-2">
        ...
        <main class="max-w-7xl mx-auto px-4 py-6 space-y-12">
            ...
            <section id="home" class="text-center space-y-6 py-6">
                <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-600/10 border border-yellow-400/20 text-yellow-400 text-[9px] font-black uppercase tracking-widest">
                    <i data-lucide="flame" class="w-3 h-3 text-red-600 animate-pulse"></i> OB54 PREMIUM EDITION
                </div>
                ...
                <p class="max-w-xs mx-auto text-white/40 text-[11px] font-medium leading-relaxed">
                    Fastest, most reliable Free Fire OB54 profile enhancement in the world.
                </p>
            ...
            <section id="api" class="space-y-4 scroll-mt-20">
                <h3 class="text-lg font-black text-white uppercase tracking-tight flex items-center gap-2">
                    <i data-lucide="terminal" class="w-5 h-5 text-yellow-400"></i> API TESTER (OB54)
                </h3>
                <div class="glass-premium p-5 rounded-3xl space-y-5 border-yellow-400/10">
                    ...
                    <button onclick="testApi()" 
                        ...
                        <i data-lucide="zap" class="w-4 h-4"></i> EXECUTE TEST (OB54)
                    </button>
                    <!-- RESPONSE AREA -->
                    <div id="response" class="bg-black/60 rounded-xl p-4 font-mono text-[9px] text-green-400 border border-yellow-400/10 min-h-[120px] whitespace-pre-wrap">
                        // OB54 System ready. Click execute to test.
                    </div>
                </div>
            </section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div class="glass-premium p-5 rounded-3xl border-white/5">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="text-base font-black text-yellow-400 uppercase">XANAF LEGACY</h4>
                                <p class="text-white/40 text-[10px] font-medium">Main channel – OB54 exclusive content</p>
                            </div>
                        </div>
                        <a href="https://t.me/XANAF_LEGACY" target="_blank" class="mt-4 flex items-center justify-center gap-2 w-full py-3 bg-white/5 active:bg-yellow-400 text-white active:text-black rounded-xl text-[10px] font-black uppercase tracking-widest border border-white/10 transition-all">
                    ...
                    <div class="glass-premium p-5 rounded-3xl border-white/5">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-white/40 text-[10px] font-medium">Gaming channel – OB54 tips & gameplay</p>
                            </div>
                        </div>
                        <a href="https://t.me/TEAM_X_LEGACY" target="_blank" class="mt-4 flex items-center justify-center gap-2 w-full py-3 bg-white/5 active:bg-yellow-400 text-white active:text-black rounded-xl text-[10px] font-black uppercase tracking-widest border border-white/10 transition-all">
                            Subscribe <i data-lucide="external-link" class="w-3 h-3"></i>
                        </a>
                    </div>
                    <!-- OMEGA X LEGACY -->
                    <div class="glass-premium p-5 rounded-3xl border-white/5">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="text-base font-black text-yellow-400 uppercase">OMEGA X LEGACY</h4>
                                <p class="text-white/40 text-[10px] font-medium">Competitive OB54 tournament coverage</p>
                            </div>
                        </div>
                        <a href="https://t.me/OMEGAX_LEGACY" target="_blank" class="mt-4 flex items-center justify-center gap-2 w-full py-3 bg-white/5 active:bg-yellow-400 text-white active:text-black rounded-xl text-[10px] font-black uppercase tracking-widest border border-white/10 transition-all">
                            Subscribe <i data-lucide="external-link" class="w-3 h-3"></i>
                        </a>
                    </div>
                </div>
            ...
            <section id="docs" class="glass-premium p-6 rounded-[2rem] border-yellow-400/10 scroll-mt-20">
                <h3 class="text-lg font-black text-white uppercase tracking-tight flex items-center gap-2 mb-4">
                    <i data-lucide="book-open" class="w-5 h-5 text-yellow-400"></i> OB54 DOCS
                </h3>
                <div class="space-y-3 text-[10px]">
                    ...
                    <div class="mt-2 text-yellow-400/40 text-[8px]">Release Version: OB54</div>
                </div>
            </section>
        </main>
            ...
            <div class="max-w-7xl mx-auto px-6 py-12 space-y-10">
                <div class="flex flex-col md:flex-row justify-between items-center gap-8">
                    <div class="text-center md:text-left space-y-4">
                        <div class="flex items-center justify-center md:justify-start gap-3">
                            ...
                            <h1 class="text-2xl font-black tracking-tighter text-gradient uppercase">XANAF LEGACY</h1>
                        </div>
                        <p class="text-white/40 text-[11px] max-w-xs">The world's most advanced OB54 profile enhancement infrastructure. Built for performance, secured for the elite.</p>
                    </div>
                    <div class="flex flex-wrap justify-center gap-3">
                        <a href="https://t.me/XANAF_LEGACY" target="_blank" class="p-3 bg-white/5 rounded-xl text-yellow-400/60 hover:text-yellow-400 border border-yellow-400/5 transition-colors"><i data-lucide="message-square" class="w-5 h-5"></i></a>
                ...
                <div class="pt-8 border-t border-yellow-400/10 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p class="text-[8px] font-black uppercase tracking-[0.4em] text-white/20">
                        © 2026 XANAF LEGACY · OB54 RED & GOLD EDITION
                    </p>
                    <div class="flex items-center gap-2 text-[8px] font-black text-white/20">
                        <span class="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse"></span> OB54 ACTIVE
                    </div>
                </div>
            </div>
        </footer>
    ...
    <script>
        ...
        function checkAccess() {
            ...
            if (key === 'XANAF-OB54-PREMIUM-2026') {
        ...
        function sharePage() {
            if (navigator.share) {
                navigator.share({ title: 'XANAF LEGACY OB54', url: window.location.href });
            } else {
        ...
        async function testApi() {
            ...
            responseDiv.innerText = '> Connecting to OB54 Legacy API...\\n> Processing UID: ' + uid + '\\n> Region: ' + region;
            try {
                ...
                responseDiv.innerText = '// OB54 Error: ' + error.message;
            }
        }

        window.onload = () => {
            if (localStorage.getItem('xanaf_access_key') === 'XANAF-OB54-PREMIUM-2026') {
                document.getElementById('auth-overlay').classList.add('hidden');
                document.getElementById('main-content').classList.remove('hidden');
                fetchStats();
            }
...
# =============================================================================
#  BACKEND FUNCTIONS (UPDATED FOR OB54)
# =============================================================================
